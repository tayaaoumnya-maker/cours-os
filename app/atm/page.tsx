...
export default function ATMApp() {
  ...
  useEffect(() => {
    ...
    // 2. Mettre à jour l'historique des sorties (les plus récentes en premier, cap 200)
    const sortedSorties = newSorties.sort((a, b) => b.at.getTime() - a.at.getTime()).slice(0, 200)
